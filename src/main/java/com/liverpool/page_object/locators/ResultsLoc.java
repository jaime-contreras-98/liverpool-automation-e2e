...
public class ResultsLoc {
    ...
    public By priceCheckboxesSection = By.cssSelector("div[class='o-aside d-aside--margin'] > div:nth-child(26)  div[class*='m-radioButton");

    @FindBy(xpath="(//div[@class='m-plp__filterSection '] /div[@class='plp-filter-options active'])[4]")
    public WebElement sizeFiltersSection;
    ...
    public WebElement totalProductsLbl;
    ...
    public List<WebElement> mainDivsSectionsList;

    @FindBy(css="div[class='m-megamenu__category_menu-item']")
    public List<WebElement> categoriesSectionsList;
